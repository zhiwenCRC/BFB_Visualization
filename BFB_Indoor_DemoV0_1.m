...
%      singleton*.
%
%      H = BFB_INDOOR_DEMOV0_1 returns the handle to a new BFB_INDOOR_DEMOV0_1 or the handle to
%      the existing singleton*.
%
%      BFB_INDOOR_DEMOV0_1('Property','Value',...) creates a new BFB_INDOOR_DEMOV0_1 using the
%      given property value pairs. Unrecognized properties are passed via
%      varargin to BFB_Indoor_DemoV0_1_OpeningFcn.  This calling syntax produces a
%      warning when there is an existing singleton*.
%
%      BFB_INDOOR_DEMOV0_1('CALLBACK') and BFB_INDOOR_DEMOV0_1('CALLBACK',hObject,...) call the
%      local function named CALLBACK in BFB_INDOOR_DEMOV0_1.M with the given input
%      arguments.
%
...
% Edit the above text to modify the response to help BFB_Indoor_DemoV0_1

% Last Modified by GUIDE v2.5 28-Dec-2016 08:36:32

% Begin initialization code - DO NOT EDIT
gui_Singleton = 0;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @BFB_Indoor_DemoV0_1_OpeningFcn, ...
                   'gui_OutputFcn',  @BFB_Indoor_DemoV0_1_OutputFcn, ...
                   'gui_LayoutFcn',  [], ...
                   'gui_Callback',   []);
...
% --- Executes just before BFB_Indoor_DemoV0_1 is made visible.
function BFB_Indoor_DemoV0_1_OpeningFcn(hObject, eventdata, handles, varargin)
...
% Choose default command line output for BFB_Indoor_DemoV0_1
...
% UIWAIT makes BFB_Indoor_DemoV0_1 wait for user response (see UIRESUME)
% uiwait(handles.figure1);
return;

% --- Outputs from this function are returned to the command line.
function varargout = BFB_Indoor_DemoV0_1_OutputFcn(hObject, eventdata, handles)
...
colormap(handles.App.ColorMapType);
...
for MPIdx = 1:MeasureNum
    ...
    Strongpaths(:,2) = Strongpaths(:,2)/max(Strongpaths(:,2));
